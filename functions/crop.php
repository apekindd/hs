<?php
function cropPng($image, $x_o, $y_o, $w_o, $h_o, $destination, $dest_w, $dest_h){
    ...
    //Ресайз
    imagecopyresampled($destination_resource, $image2, $dest_w-$w_o, 0, 0, 0, $w_o, $h_o, imagesx($image2), imagesy($image2));
